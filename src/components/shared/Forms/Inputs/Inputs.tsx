...
export const Select = (props: any) => {
  return (
    <div className="">
      ...
      <select name={props.name} onChange={props.onChange} className="mt-1 p-[10px] block w-full rounded-xl border-[#BDBDBD] text-[#333333] outline-0 bg-transparent border-[2px] focus:border-[#1d724b] mb-3">
