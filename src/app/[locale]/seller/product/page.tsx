        ...
        <div className="p-5 bg-[#FFFFFF] w-full md:w-[500px] mx-auto ">
            <div>
                ...
                <div className='flex outline rounded-[8px] mb-3'>
                    <button className='btn bg-green-800 p-1 w-full rounded-[15px] text-[#FFFFFF]'>tab1</button>
                    <button className='btn bg-[#FFFFFF] p-1 w-full rounded-[15px] text-[#000000] -ms-6'>tab2</button>
                </div>
