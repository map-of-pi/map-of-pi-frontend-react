...
function PrivacyPolicy() {
  ...
  return (
    ...
    <ul>
      <li><strong>2.1 {t('PRIVACY_POLICY.SECTIONS.SUBHEADER_2_1')}</strong>
        <ul>
          <li>{t('PRIVACY_POLICY.SECTIONS.CONTENT_2_1_1')}</li>
          <li>{t('PRIVACY_POLICY.SECTIONS.CONTENT_2_1_2')}</li>
        </ul>
      </li>
      <li><strong>2.2 {t('PRIVACY_POLICY.SECTIONS.SUBHEADER_2_2')}</strong>
        <ul>
    ...
    <ul>
      <li><strong>3.1 {t('PRIVACY_POLICY.SECTIONS.SUBHEADER_3_1')}</strong>
        <ul>
          <li>{t('PRIVACY_POLICY.SECTIONS.CONTENT_3_1_1')}</li>
        </ul>
      </li>
      <li><strong>3.2 {t('PRIVACY_POLICY.SECTIONS.SUBHEADER_3_2')}</strong>
        <ul>
          <li>{t('PRIVACY_POLICY.SECTIONS.CONTENT_3_2_1')}</li>
        </ul>
      </li>
      <li><strong>3.3 {t('PRIVACY_POLICY.SECTIONS.SUBHEADER_3_3')}</strong>
        <ul>
    ...
    <ul>
      <li><strong>4.1 {t('PRIVACY_POLICY.SECTIONS.SUBHEADER_4_1')}</strong>
        <ul>
          <li>{t('PRIVACY_POLICY.SECTIONS.CONTENT_4_1_1')}</li>
        </ul>
      </li>
      <li><strong>4.2 {t('PRIVACY_POLICY.SECTIONS.SUBHEADER_4_2')}</strong>
        <ul>
    ...
    <ul>
      <li>{t('PRIVACY_POLICY.SECTIONS.CONTENT_8_1')} &#64; <strong><a href={`mailto:${emailAddress}`}>Map of
            Pi</a></strong>.</li>
    </ul>
</div>
